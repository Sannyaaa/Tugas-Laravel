    <!-- START: HEADER -->
    <header class="{{ request()->route() == 'index' ? 'absolute' : 'Tidak Aktif' }} w-full z-50 px-4">
              ...
              <div class="w-auto">
                ...
                >
                  <li class="mx-3 py-6 md:py-0">
                    <a href="#" class="text-black {{ request()->route() == 'index' ? 'md:text-white' : '' }} hover:underline"
                      >Showcase</a
                    >
                  </li>
                  <li class="mx-3 py-6 md:py-0">
                  ...
                  @auth
                    ...
                    <li class="mx-3 py-6 md:py-0">
                      <a href="{{ route('dashboard') }}" class="text-black {{ request()->route() == 'index' ? 'md:text-white' : '' }} hover:underline"
                        >Dashboard</a
                      >
                    </li>
                  @endauth
                  @guest
                    <li class="mx-3 py-6 md:py-0">
                      <a href="{{ route('login') }}" class="text-black {{ request()->route() == 'index' ? 'md:text-white' : '' }} hover:underline"
                        >Login</a
                      >
                    </li>
                  @endguest
