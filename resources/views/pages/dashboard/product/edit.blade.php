          ...
          <div class="py-12">
              <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                  <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-10">
                    ...
                    <form action="{{ route('product.update', $product->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3 mb-8">
                                ...
                                <input type="text" value="{{ old('name') ?? $product->name }}" placeholder="Product name" name="name" id="name" 
                            ...
                            <div class="w-full px-3 mb-8">
                                ...
                                <input type="number" value="{{ old('price') ?? $product->price }}" placeholder="Product price" name="price" id="price" 
                                class="block w-full bg-gray-200 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            </div>
