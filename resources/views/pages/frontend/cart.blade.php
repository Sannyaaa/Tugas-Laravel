        ...
        <section class="bg-gray-100 py-8 px-4">
          <div class="container mx-auto">
            <ul class="breadcrumb">
              ...
              <li>
                <a href="{{ route('cart') }}" aria-label="current-page">Shopping Cart</a>
              </li>
            </ul>
          </div>
        </section>
              ...
              <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
                ...
                @forelse ($carts as $cart)
                  ...
                  <div
                    ...
                    data-row="1"
                  >
                    {{-- {{ dd($cart->products->galleries) }} --}}
                    <div class="px-4 flex-none">
                      <div class="" style="width: 90px; height: 90px">
                        <img
                          src="{{ $cart->products->galleries()->exists() ? Storage::url($cart->products->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                          alt="chair-1"
                    ...
                    <div class="px-4 w-auto flex-1 md:w-5/12">
                      <div class="">
                        ...
                        >
                          IDR {{ number_format($cart->products->price) }}
                        </h6>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      <div class="">
                        <h6 class="font-semibold text-lg">IDR {{ number_format($cart->products->price) }}</h6>
                      </div>
                    </div>
                    <div class="px-4 w-2/12">
                      <div class="text-center">
